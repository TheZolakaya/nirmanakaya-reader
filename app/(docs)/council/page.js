      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-zinc-900/30 backdrop-blur-sm text-center py-6 border-b border-zinc-800/30">
        ...
        <div className="overflow-x-auto mt-3">
          <div className="flex gap-2 text-xs w-max mx-auto px-4">
            ...
            <Link href="/about" className="px-3 py-1.5 rounded bg-zinc-900/90 border border-zinc-600/60 text-zinc-300 hover:text-cyan-400 hover:border-cyan-500/50 transition-all shrink-0">About</Link>
            <Link href="/lounge" className="px-3 py-1.5 rounded bg-zinc-900/90 border border-zinc-600/60 text-zinc-300 hover:text-violet-400 hover:border-violet-500/50 transition-all shrink-0">Lounge</Link>
