              ...
              <div className="flex justify-center mb-1 px-2">
                ...
                <div className="inline-flex rounded-lg bg-zinc-900 p-0.5 mode-tabs-container gap-0.5">
                  ...
                  <button
                    ...
                    className={`mode-tab px-1 sm:px-3 py-0.5 sm:py-1 rounded-md text-[0.5rem] sm:text-[0.7rem] font-mono uppercase tracking-[0.02em] sm:tracking-[0.1em] transition-all ${
