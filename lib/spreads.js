...
//
// STRUCTURAL KEY:
//   Count 1 = Seed stage    | Count 2 = Bridge stage
...
export const REFLECT_SPREADS = {
  ...
  'mind-1': {
    ...
    stage: 'seed',
    element: 'fire',
    archetype: { number: 4, verb: 'Authority', traditional: 'The Emperor' },
  ...
  'emotion-3': {
    ...
    stage: 'fruition',
    element: 'earth',
    archetype: { number: 13, verb: 'Transformation', traditional: 'Death' },
  ...
  'gestalt-4': {
    ...
    stage: 'feedback',
    element: 'water',
    archetype: { number: 20, verb: 'Recognition', traditional: 'Judgement' },
    concern: null
  },
  ...
  'emotion-4': {
    ...
    stage: 'feedback',
    element: 'air',
    archetype: { number: 14, verb: 'Tune', traditional: 'Temperance' },
  ...
  'body-4': {
    ...
    stage: 'feedback',
    element: 'fire',
    archetype: { number: 12, verb: 'Faith', traditional: 'The Hanged Man' },
    bridge: 'The Devoted',
    concern: 'death'
  },
  ...
  'cycle': {
    ...
    positions: [
      { id: 1, name: "Definition", lens: "This signature is the beginning energy of your process. Read it as: how it started." },
