...
export const REFLECT_SPREADS = {
    ...
    positions: [
      {
        ...
        lens: "This signature is the single most important signal across your whole life right now. Read it as: the one thing that needs your attention above everything else. Don't narrow — this is the big picture reduced to one pulse."
      }
    ],
  ...
  'spirit-1': {
    ...
    whenToUse: "When you've lost the spark and need to find it",
    whatYoullSee: "Where meaning is right now — even if it's quiet",
    house: 'spirit',
    stage: 'seed',
    element: 'air',
    ...
    positions: [
      {
        id: 1,
        name: "What's Clear",
        lens: "This signature is the single clearest signal about your thinking, your choices, and your understanding right now. Read it as: the one thought or insight that cuts through the fog. This is about agency and clarity."
      }
    ],
    whenToUse: "When your head is foggy and you need one clear thought",
  ...
  'body-1': {
    ...
    whenToUse: "When you feel ungrounded and need to know what's real",
  ...
  'gestalt-2': {
    ...
    whenToUse: "When something feels off between how you feel and how life is going",
  ...
  'spirit-2': {
    ...
    whenToUse: "When you can't tell if you should keep searching or start building",
    whatYoullSee: "The gap between what you're seeking and what's already here",
    house: 'spirit',
    stage: 'medium',
    element: 'earth',
  ...
  'mind-2': {
    ...
    whatYoullSee: "Where you need more freedom and where you need more structure",
    house: 'mind',
    stage: 'medium',
    element: 'water',
    ...
    positions: [
      {
        id: 1,
        name: "What to Hold",
        lens: "This signature is what needs sustained effort right now — the endurance, persistence, and structure you're right to keep maintaining. Read it as: what you should keep carrying."
      },
      {
        id: 2,
        name: "What to Release",
        lens: "This signature is what's ready to be set down — the sacrifice, completion, or surrender that's active. Read it as: what you can stop holding."
      }
    ],
    whenToUse: "When you can't tell what to keep and what to let go of",
    whatYoullSee: "What needs sustained effort and what's ready to be set down",
    house: 'body',
    stage: 'medium',
    element: 'air',
  ...
  'mind-3': {
    ...
    positions: [
      ...
      },
      {
        id: 3,
        name: "What to Do",
        lens: "This signature is how your understanding wants to translate into action. Read it as: the next move — what becomes possible when you act on what you know."
      }
    ],
    whenToUse: "When you can see something but can't figure out what to do about it",
    whatYoullSee: "The chain from seeing to understanding to action — and where it breaks",
    house: 'mind',
    stage: 'fruition',
    element: 'air',
  ...
  'emotion-3': {
    ...
    whenToUse: "When emotion is present but you can't tell what to do with it",
  ...
  'body-3': {
    ...
    whenToUse: "When effort isn't producing results and you can't see why",
  ...
  'gestalt-4': {
    ...
    whenToUse: "When life feels off and you can't tell where",
  ...
  'mind-4': {
    ...
    positions: [
      ...
      {
        id: 4,
        name: "What Needs to Break",
        lens: "This signature is how you're clearing false structure — your capacity for creative destruction that makes room for what's real. Read it as: the false floors, stale systems, or outdated frameworks that need to go. The Disruptor bridge: when balanced, precise demolition in service of better building. When over-expressed, 'burn it all down' — destruction without constructive purpose. When depleted, 'I see the lies but can't bring myself to act' — frozen inside a structure you know is wrong."
      }
    ],
  ...
  'emotion-4': {
    ...
    whenToUse: "When relationships or feelings are complicated and you need the full picture",
  ...
  'body-4': {
    ...
    whenToUse: "When nothing's working in reality and you need to know why",
