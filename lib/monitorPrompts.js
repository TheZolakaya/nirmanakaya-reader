 ...
 */
export const DAILY_COLLECTIVE_FORMAT = `RESPOND IN EXACTLY THIS FORMAT:

[READING]
{2-3 sentences interpreting this card for the COLLECTIVE. Be warm and clear.
Name the card and status, describe the pattern in accessible language.
If trend context is provided, weave in what shifted since yesterday — but don't force it.}

[CORRECTION]
{If imbalanced: 1 sentence naming the correction path in plain language.
If balanced: skip this section entirely.}

RULES:
- Maximum 80 words total
- No preamble, no sign-off, no disclaimers
- Use collective language only — NEVER "you" or "your"
- Warm, grounded tone — like a trusted friend reading the weather
- Describe STATE, not prediction
- Present tense, accessible, clear
- Stay in architectural register — patterns, not prescriptions
- Do NOT name specific companies, politicians, legislation, or current events
`;
...
TODAY'S CARD: ${card.signature}
Status: ${statusNote}
${correction}

Interpret briefly for the COLLECTIVE. Be warm and clear. ${previousReading ? 'Note what shifted from yesterday.' : ''}

FINAL CHECK: If "you" or "your" appears, rewrite using collective pronouns.`;
}
