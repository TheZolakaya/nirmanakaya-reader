...
/**
 * Monitor meanings aligned with Houses
...
/**
 * Scope meanings for non-monitor collective readings
 */
export const SCOPES = {
  individual: {
    id: 'individual',
...
// V3: Stance system removed. buildStancePrompt no longer exists.
const buildStancePrompt = () => '';
