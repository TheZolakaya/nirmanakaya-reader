...
//   Outer Pair (LENS): Actualization (19) × Recognition (20)
...
export function getGestaltCondition(drawMap) {
  ...
  const governance = [
    ...
    { archId: 20, name: 'Recognition',      status: STATUS_NAMES[awareness],     house: 'Emotion', balanced: awareness === B },
  ];
