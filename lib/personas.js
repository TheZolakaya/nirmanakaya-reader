...
`;
  ...
  // Persona, Humor, Register only apply when persona !== 'none'
  if (persona !== 'none' && PERSONA_PROMPTS[persona]) {
    prompt += `
=== PERSONA VOICE ===
...
Do not write formally and then adjust — write naturally AS this persona.
The voice should be consistent across all sections (cards, letter, synthesis).
NEVER use pet names like "honey", "sweetie", "dear" — show warmth through tone, not labels.
`;
  }
