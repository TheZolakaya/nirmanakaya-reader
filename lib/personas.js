...
HUMOR LEVEL ${humor}/10: ${humor === 1 ? 'MAXIMUM COMEDY. Every section needs jokes. Roast the situation. "bruh the cards said 💀" "of COURSE you drew this" "I cannot with this reading rn". Find what\'s absurd and LEAN INTO IT.' : humor === 2 ? 'Very funny throughout. Jokes in every section. Witty observations. Make them laugh.' : humor <= 3 ? 'GENUINELY FUNNY with real jokes and comedic timing' : humor >= 8 ? 'Maintain full gravity and seriousness' : 'Balance insight with appropriate lightness'}.
...
${humor <= 2 || register <= 2 ? 'THIS IS NOT OPTIONAL. If the output reads like a formal reading, you have FAILED the instruction. Be actually funny. Be actually casual. Commit to the bit.' : ''}
