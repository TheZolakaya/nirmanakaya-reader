...
//   Mind:    Authority(4) × Culture(5)         | Abstraction(15) × Breakthrough(16)
//   Emotion: Compassion(6) × Drive(7)     | Transformation(13) × Tune(14)
//   Body:    Fortitude(8) × Discipline(9)  | Equity(11) × Faith(12)
//
...
// Inner: Authority (4) × Culture (5) = "The Frame"
...
const MIND_FRAME_DESC = {
  'Lattice':    'Well-built mental framework. Authority is clear and culture is healthy — thoughts have structure and values have community.',
  ...
  'Blueprint':  'Structure without community. Authority is clear but culture has withdrawn — well-organized isolation. Who could benefit from your frameworks?',
...
// Outer: Transformation (13) × Tune (14) = "The Tide"
...
const EMOTION_TIDE_DESC = {
  'Harmony':      'Emotional grace. Transformation flows naturally and balance holds — transformation in equilibrium. The tide at its best.',
  'Tightrope':    'Precarious grace. Transformation is clear but balance is overworking — transforming while desperately holding center. Breathe.',
...
// Outer: Equity (11) × Faith (12) = "The Scale"
...
const HOUSE_CONFIG = {
  ...
  Mind: {
    ...
    innerMembers: [4, 5],    // Authority, Culture
  ...
  Emotion: {
    ...
    outerMembers: [13, 14],  // Transformation, Tune
  ...
  Body: {
    ...
    outerMembers: [11, 12],  // Equity, Faith
