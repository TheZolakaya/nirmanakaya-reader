...
function parseProgressiveDepthResponse(responseText, draws) {
  ...
  sections.path.surface = extractSection(responseText, 'PATH:SURFACE', [...pathEndMarkers, 'PATH:WADE', 'PATH:SWIM', 'PATH:DEEP', 'PATH:ARCHITECTURE']);
  sections.path.wade = extractSection(responseText, 'PATH:WADE', [...pathEndMarkers, 'PATH:SWIM', 'PATH:DEEP', 'PATH:ARCHITECTURE']);
  sections.path.swim = extractSection(responseText, 'PATH:SWIM', [...pathEndMarkers, 'PATH:DEEP', 'PATH:ARCHITECTURE']);
  sections.path.deep = extractSection(responseText, 'PATH:DEEP', [...pathEndMarkers, 'PATH:ARCHITECTURE']);
