...
CRITICAL: You MUST name the position "${domainContext}" in your interpretation text. Not just in headers — in the actual prose. Example: "${trans.name} in ${domainContext} means..." The position gives the card meaning.`;
  }).join('\n\n');
}
