...
export function buildSystemPrompt(userLevel, options = {}) {
  ...
  // V1: Always use posture header (includes tone governance)
  // Map spreadType to posture for backward compatibility
  ...
  const archBlock = showArchitecture
    ? '\nARCHITECTURE VISIBLE: Use structural terminology freely — house names, channel names, process stages, rebalancer geometry. The user wants to see the scaffolding.\n'
