...
[LETTER:SURFACE], [LETTER:WADE], [LETTER:SWIM], [LETTER:DEEP], [SUMMARY:SURFACE], [SUMMARY:WADE], [SUMMARY:SWIM], [SUMMARY:DEEP], ${cardMarkerList}, [PATH:SURFACE], [PATH:WADE], [PATH:SWIM], [PATH:DEEP], [PATH:ARCHITECTURE] (if 2+ imbalanced), [FULL_ARCHITECTURE] (optional, last).

CRITICAL: Generate sections in this EXACT order - Letter first, then Summary (all 4 depths), then each Card with its Rebalancer, then Path, then Full Architecture last.
