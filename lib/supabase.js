...
// Get all users opted in to updates (for broadcasts) - requires service role
// This is called from API routes with admin supabase client
export async function getUsersForBroadcast(supabaseAdmin) {
