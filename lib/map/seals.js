...
export const SEAL_40 = {
  ...
  // Cols: Spirit, Emotion, Mind, Body
  matrix: [
    [17,  7,  4, 12],  // Fire/Intent:     Inspiration, Drive, Authority, Faith
    [ 2, 14, 15,  9],  // Air/Cognition:   Wisdom, Tune, Abstraction, Discipline
    [18,  6,  5, 11],  // Water/Resonance: Imagination, Compassion, Culture, Equity
    [ 3, 13, 16,  8],  // Earth/Structure: Nurturing, Transformation, Breakthrough, Fortitude
  ],
 ...
 * 2 = Bridge (process, transformation)
...
export const SEAL_10 = {
  ...
  stages: {
    ...
    2: { name: 'Bridge', description: 'Process, transformation, cultivation' },
