...
//
// TERMINOLOGY:
// - Opportunities: Tuned state growth paths
...
/**
 * POLARITY PAIRS (Tuned opportunity - diagonal)
...
/**
 * Get all archetypes by function (Seed, Bridge, Fruition, Feedback)
 * @param {string} func - 'Seed' | 'Bridge' | 'Fruition' | 'Feedback' | 'Ingress' | 'Egress'
...
export const FUNCTIONS = ['Seed', 'Bridge', 'Fruition', 'Feedback', 'Ingress', 'Egress'];
