...
1. Open with what emerges — "[Name] emerges..." — and ground in purpose
2. Name what consciousness is DOING (the House command), where it's creating from
3. Address status: [Balanced] = purpose flowing, creating in the present. Imbalanced = in [Un-Now], purpose blocked or borrowed
4. If imbalanced, name where purpose recovers (the path home)
5. Close with the teaching/question and return to presence
