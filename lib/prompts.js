...
FORMAT REQUIRED — separate each signature with clear spacing:

**[Signature 1 Name]**
Recognition line addressing what's happening.
Now question? (if imbalanced) or Value confirmation (if balanced).

**[Signature 2 Name]**
Recognition line addressing what's happening.
Now question? (if imbalanced) or Value confirmation (if balanced).

(Continue for each signature in the reading)
