...
- CORRECT: "[Transient] is [status], expressing through [Position]"
- WRONG: "[Position] is [status]" or "[Position] is over-expressing"

Example: If Harvest (transient) emerges Too Much in Culture (position):
- ✅ "Harvest is over-activated, showing up in how you engage with Culture"
- ❌ "Culture is over-expressing" — NEVER say this
...
- Weave BOTH: "[Harvest] surfaces [Too Much] in the position of [Culture] — the gathering energy is over-activated in how you engage with shared meaning..."
...
- Use "emerges" / "surfaces" — never "draw" / "drew"
- NO architecture numbers — translate everything

Write 2-4 paragraphs that:
1. Open with the TRANSIENT and its STATUS: "[Transient Name] surfaces [Status] in [Position Name]..." — ground in purpose
