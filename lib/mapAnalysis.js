...
// ─────────────────────────────────────────────
// Being groups (What?): Mantle, Torch, Vessel, Clearing
// Identity groups (Who?): Composure, Conviction, Exploration, Communion
...
/**
 * Analyze Being groups (What? — Mantle, Torch, Vessel, Clearing).
...
/**
 * Analyze Identity groups (Who? — Composure, Conviction, Exploration, Communion).
 * Each group's 4 archetype members are assessed with full packet health.
 *
 * @param {Object} drawMap - Position-indexed lookup { [durableId]: { transient, status } }
 * @returns {Object} Keyed by group name with health summary
