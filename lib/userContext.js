...
export function buildUserContextBlock(stats, currentDraws, recentReadings, topicData, profile, personalFacts, narrativeReadings) {
  ...
  if (narrativeReadings && narrativeReadings.length > 0) {
    ...
    if (withSummary.length > 0) {
      ...
      // Aggregate hashtag frequencies across all recent readings
      const tagCounts = {};
      ...
      lines.push('Honor this thread — the querent\'s journey has continuity. Weave awareness of where they\'ve been into your opening naturally.');
