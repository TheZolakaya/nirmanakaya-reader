...
export const GOVERNANCE_MAP = {
  ...
  20: { house: 'Emotion', label: 'Recognition governs Emotion' },
...
export const HOUSES = {
  Gestalt: {
    ...
    extended: "Gestalt contains the archetypes of unified selfhood: Potential (0), Will (1), Actualization (19), and Recognition (20). Governed by Source (10), this house represents the complete self — not as a collection of parts, but as an integrated whole that is more than the sum of its components."
  },
  Spirit: {
    name: "Spirit",
    members: [2, 3, 17, 18],
  ...
  Mind: {
    ...
    extended: "Mind contains the archetypes of mental organization: Authority (4), Culture (5), Abstraction (15), and Breakthrough (16). Governed by Actualization (19), this house represents how we structure reality through thought, language, and systems."
  },
  Emotion: {
    name: "Emotion",
    members: [6, 7, 13, 14],
    ...
    extended: "Emotion contains the archetypes of feeling and motivation: Compassion (6), Drive (7), Transformation (13), and Tune (14). Governed by Recognition (20), this house represents our capacity to feel, connect, and be moved toward action."
  },
  Body: {
    name: "Body",
    members: [8, 9, 11, 12],
    ...
    extended: "Body contains the archetypes of embodied practice: Fortitude (8), Discipline (9), Equity (11), and Faith (12). Governed by Will (1), this house represents how we manifest in physical reality through endurance, skill, fairness, and release."
  },
  Portal: {
    name: "Portal",
    members: [10, 21],
...
export const BEING_GROUPS = {
  ...
  Kindle: {
    ...
    members: [2, 5, 13, 12],  // Wisdom, Culture, Transformation, Sacrifice
    stages: { Seed: 2, Bridge: 5, Fruition: 13, Feedback: 12 },
    description: "Knowing — thresholds crossed. What is received, carried, and transmitted forward.",
    extended: "Kindle contains the archetypes of transmission: Wisdom (Spirit/Cognition), Culture (Mind/Resonance), Transformation (Emotion/Structure), Faith (Body/Intent). A flame is kindled, carried through darkness, and passed forward — the light passes through the carrier, illuminating what it touches. The Transmission Cycle: silent perception becomes teachable form, teaching transforms, transformation demands physical surrender, surrender empties you for the next perception."
  },
  Vessel: {
    name: "Vessel",
    question: "What?",
    ...
    members: [4, 3, 11, 14],  // Authority, Nurturing, Equity, Tune
    stages: { Seed: 4, Bridge: 3, Fruition: 11, Feedback: 14 },
    description: "Form — containment and stewardship. Right relationship between parts, held together.",
    extended: "Vessel contains the archetypes of holding: Authority (Mind/Intent), Nurturing (Spirit/Structure), Equity (Body/Resonance), Tune (Emotion/Cognition). A vessel holds, carries, maintains shape so something can exist inside it. The Stewardship Cycle: blueprint becomes living home, living home meets reality and calibrates, calibration finds dynamic equilibrium, equilibrium reveals where the blueprint needs redesigning."
  },
  Passage: {
    name: "Passage",
    question: "What?",
...
export const IDENTITY_GROUPS = {
  Composure: {
    ...
    center: "Holds center",
    members: [8, 5, 17, 14],  // Fortitude, Culture, Inspiration, Tune
    stages: { Seed: 8, Bridge: 5, Fruition: 17, Feedback: 14 },
    description: "Centered presence — the gyroscope. Steady through continuous, quiet motion.",
    extended: "Composure contains the archetypes of centered presence: Fortitude (Body/Structure), Culture (Mind/Resonance), Inspiration (Spirit/Intent), Tune (Emotion/Cognition). No archetype of destruction in this group — Fortitude tames with open hands, Culture channels patiently, Inspiration radiates calmly, Balance pours without spilling. The Centering Cycle: plant your feet, find your lineage, become what people navigate by, keep pouring without emptying."
  },
  Conviction: {
    name: "Conviction",
    question: "Who?",
    ...
    stages: { Seed: 2, Bridge: 7, Fruition: 11, Feedback: 16 },
  ...
  Exploration: {
    ...
    members: [4, 9, 13, 18],  // Authority, Discipline, Transformation, Imagination
    stages: { Seed: 4, Bridge: 9, Fruition: 13, Feedback: 18 },
    ...
    extended: "Exploration contains the archetypes of venturing: Authority (Mind/Intent), Discipline (Body/Cognition), Transformation (Emotion/Structure), Imagination (Spirit/Resonance). Each engages the unknown differently — the Emperor claims it, the Hermit walks into it, Death surrenders to it, the Moon lives in it. The Exploration Cycle: claim sovereignty over the question, walk into claimed territory alone, what you find transforms you, the Moon's reflective pool shows what the old you couldn't see."
  },
  Intimacy: {
    name: "Intimacy",
    question: "Who?",
    verb: "Merge",
    cycle: "The Intimacy Cycle",
    center: "Dissolves center into other",
    members: [6, 3, 15, 12],  // Compassion, Nurturing, Abstraction, Sacrifice
    stages: { Seed: 6, Bridge: 3, Fruition: 15, Feedback: 12 },
    description: "Dissolved boundaries — entanglement with another. Maximum enmeshment, the opposite of Composure.",
    extended: "Intimacy contains the archetypes of dissolved boundaries: Compassion (Emotion/Resonance), Nurturing (Spirit/Structure), Abstraction (Mind/Cognition), Faith (Body/Intent). Lovers merge, Empress holds creation inseparably, Devil reveals the chains, Hanged Man surrenders will. The Intimacy Cycle: resonance cracks you open, entanglement becomes fertile, the living bond casts a shadow revealing chains, seeing the chains you choose — offering up the unconscious version so what remains can be chosen rather than compelled."
  }
};
...
export const DIMENSION_VERBS = {
  ...
  Being:    { Mantle: "Underlie", Kindle: "Understand", Vessel: "Hold", Passage: "Release" },
  Identity: { Composure: "Center", Conviction: "Act", Exploration: "Venture", Intimacy: "Merge" }
};
...
// Process Stage data for popups (Seed, Bridge, Fruition, Feedback)
export const PROCESS_STAGES = {
  ...
  Bridge: {
    ...
    extended: "Bridge carries and develops. Yin-within-Yang, the sustained work of becoming. Like summer, like the held breath. The Bridge transmits energy from beginning toward completion."
  },
  Fruition: {
    name: "Fruition",
    character: "Yin-pure",
