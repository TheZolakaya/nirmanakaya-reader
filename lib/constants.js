...
export const HOUSES = {
  ...
  Portal: {
    ...
    extended: "Portal contains the archetypes of transition: Source (10) as Ingress and Creation (21) as Egress. This house has no governor — it represents the thresholds through which consciousness enters and exits the system, the turning points of becoming."
  }
};
