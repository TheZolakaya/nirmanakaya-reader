...
export const IDENTITY_GROUPS = {
  ...
  Intimacy: {
    ...
    extended: "Intimacy contains the archetypes of dissolved boundaries: Compassion (Emotion/Resonance), Nurturing (Spirit/Structure), Abstraction (Mind/Cognition), Sacrifice (Body/Intent). Lovers merge, Empress holds creation inseparably, Devil reveals the chains, Hanged Man surrenders will. The Intimacy Cycle: resonance cracks you open, entanglement becomes fertile, the living bond casts a shadow revealing chains, seeing the chains you choose — offering up the unconscious version so what remains can be chosen rather than compelled."
  }
};
