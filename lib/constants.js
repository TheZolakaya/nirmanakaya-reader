...
export const HOUSES = {
  ...
  Emotion: {
    ...
    extended: "Emotion contains the archetypes of feeling and motivation: Compassion (6), Drive (7), Change (13), and Tune (14). Governed by Recognition (20), this house represents our capacity to feel, connect, and be moved toward action."
  },
  Body: {
    name: "Body",
    members: [8, 9, 11, 12],
...
export const IDENTITY_GROUPS = {
  ...
  Exploration: {
    ...
    members: [4, 9, 13, 18],  // Authority, Discipline, Change, Imagination
