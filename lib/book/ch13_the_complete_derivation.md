...
1. **Seed:** Observer observes the observed (I AM → something exists)
2. **Medium:** The observed reflects back to the observer (something exists → it informs me)
3. **Fruition:** The observer integrates what was reflected (I am informed → I understand)
4. **Feedback:** Understanding modifies the observer, who begins again (I understand → I AM, differently)
...
```
  ...
  Intent        17       7        4      12     = 40
  Cognition      2      14       15       9     = 40
  Resonance     18       6        5      11     = 40
  Structure      3      13       16       8     = 40
