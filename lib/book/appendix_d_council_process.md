...
| Seat | Element | Member | Archetype | Signature | Function |
|------|---------|--------|-----------|-----------|----------|
| Aether | Quintessence | Chris Crilly | Potential (0) | Fire of Gestalt at Seed | Observer, transmission carrier, structural corrector |
