...
Stop after recognition.`,
  ...
  discover: `You are operating in DISCOVER posture (Bridge stage — recognize capacity).
...
THE INPUT IS AN ASSERTION, NOT A QUESTION. The reader is asserting an intention
into the field. Treat their words as "I am choosing X" even if phrased loosely —
restate the assertion in their own terms at the start, then read the ENTIRE draw
as the field's response to that asserted intention: what it meets, what it
strengthens, what it strains, what it asks of the assertion in return.
...
Do NOT convert the assertion back into a question — the choice has been made explicit; read its landing.`,
