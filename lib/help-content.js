...
export const HELP_CONTENT = {
  ...
  'mode-explore': {
    title: 'Explore Mode',
    text: 'Threaded conversation with the signatures. Each signature becomes a doorway for deeper inquiry through follow-up questions.',
    related: []
  },
  ...
  'spread-triad': {
    title: 'Triad Spread',
    text: 'Three signatures exploring a dynamic. Common layouts: Past-Present-Future, Situation-Challenge-Advice.',
  },
  'spread-pentad': {
    title: 'Pentad Spread',
  ...
  'spread-septad': {
    title: 'Septad Spread',
    text: 'Seven signatures for comprehensive analysis. Maps the full arc of a situation with maximum depth.',
  },
  'spread-selector': {
    title: 'Spread Selector',
    text: 'Choose how many signatures to encounter and their layout. More signatures provide more nuance but require more time.',
  },
  ...
  'card-click': {
    ...
    text: 'Click any signature name to see its full definition, associations, and related concepts.',
  },
  'status-click': {
  ...
  'get-reading': {
    title: 'Get Reading',
    text: 'Begin the encounter with your current question and settings. Signatures will emerge and be interpreted.',
  },
  ...
  'stance-adjust': {
    title: 'Adjust Stance',
    text: 'Change voice settings mid-encounter. Re-interpret the same signatures with different delivery.',
  },
  ...
  'section-signatures': {
    ...
    text: 'Overview of all signatures encountered. Each signature combines an identity with an expression status.',
  },
  'section-synthesis': {
    title: 'Synthesis Section',
    text: 'The integrated meaning of all signatures together. Shows how they interact to address your question.',
  },
  'section-path': {
    title: 'Path Section',
