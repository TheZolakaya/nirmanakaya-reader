...
// CANONICAL BOUND GROWTH - Direct lookup from CANONICAL_78_CORRECTIONS.md
...
const BOUND_GROWTH_TARGETS = {
  ...
  23: 57,    // 2 of Wands → 6 of Pentacles
  24: 39,    // 3 of Wands → 8 of Swords
  25: 48,    // 4 of Wands → 7 of Cups
  26: 60,    // 5 of Wands → 9 of Pentacles
  27: 53,    // 6 of Wands → 2 of Pentacles
  28: 45,    // 7 of Wands → 4 of Cups
  29: 34,    // 8 of Wands → 3 of Swords
  30: 56,    // 9 of Wands → 5 of Pentacles
  31: null,  // 10 of Wands → self (Potential/Gestalt)
  // SWORDS
  32: null,  // Ace of Swords → self (Actualization/Gestalt)
  33: 29,    // 2 of Swords → 8 of Wands
  34: 48,    // 3 of Swords → 7 of Cups
  35: 49,    // 4 of Swords → 8 of Cups
  36: 59,    // 5 of Swords → 8 of Pentacles
  37: 54,    // 6 of Swords → 3 of Pentacles
  38: 44,    // 7 of Swords → 3 of Cups
  39: 45,    // 8 of Swords → 4 of Cups
  40: 24,    // 9 of Swords → 3 of Wands
  41: null,  // 10 of Swords → self (Actualization/Gestalt)
  // CUPS
  42: null,  // Ace of Cups → self (Awareness/Gestalt)
  43: 28,    // 2 of Cups → 7 of Wands
  44: 38,    // 3 of Cups → 7 of Swords
  45: 39,    // 4 of Cups → 8 of Swords
  46: 58,    // 5 of Cups → 7 of Pentacles
  47: 55,    // 6 of Cups → 4 of Pentacles
  48: 34,    // 7 of Cups → 3 of Swords
  49: 35,    // 8 of Cups → 4 of Swords
  50: 25,    // 9 of Cups → 4 of Wands
  51: null,  // 10 of Cups → self (Awareness/Gestalt)
  // PENTACLES
  52: null,  // Ace of Pentacles → self (Will/Gestalt)
  53: 27,    // 2 of Pentacles → 6 of Wands
  54: 37,    // 3 of Pentacles → 6 of Swords
  55: 47,    // 4 of Pentacles → 6 of Cups
  56: 30,    // 5 of Pentacles → 9 of Wands
  57: 23,    // 6 of Pentacles → 2 of Wands
  58: 46,    // 7 of Pentacles → 5 of Cups
  59: 36,    // 8 of Pentacles → 5 of Swords
  60: 26,    // 9 of Pentacles → 5 of Wands
...
// Agent correction follows archetype path with channel crossing + role flip
// The target channel is determined by the target archetype's channel
// Example: Balanced Knight of Wands (Order/Intent) → Queen of Swords (Wisdom/Cognition, Catalyst→Steward)
export function getAgentCorrection(agent, status) {
  ...
  // 4. Determine the target role by flipping
  const targetRole = ROLE_FLIP[agent.role];
  ...
  // 6. Find the Agent in the target channel with flipped role
