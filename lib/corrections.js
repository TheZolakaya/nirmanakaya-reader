...
const AGENT_DIAGONAL_TARGETS = {
  ...
  63: 67,    // Catalyst of Intent (Order 4) → Catalyst of Cognition (Abstraction 15)
  64: 68,    // Steward of Intent (Drive 7) → Steward of Cognition (Tune 14)
  65: 69,    // Executor of Intent (Sacrifice 12) → Executor of Cognition (Discipline 9)
  66: 62,    // Initiate of Cognition (Wisdom 2) → Initiate of Intent (Inspiration 17)
  67: 63,    // Catalyst of Cognition (Abstraction 15) → Catalyst of Intent (Order 4)
  68: 64,    // Steward of Cognition (Tune 14) → Steward of Intent (Drive 7)
  69: 65,    // Executor of Cognition (Discipline 9) → Executor of Intent (Sacrifice 12)
...
// (Fortitude 8 → vertical 12 Sacrifice → its resident Executor), never a rank flip.
const AGENT_VERTICAL_TARGETS = {
  62: 74,    // Initiate of Intent (Inspiration 17) → Initiate of Structure (Nurturing 3)
  63: 75,    // Catalyst of Intent (Order 4) → Catalyst of Structure (Breakthrough 16)
  64: 76,    // Steward of Intent (Drive 7) → Steward of Structure (Change 13)
  65: 77,    // Executor of Intent (Sacrifice 12) → Executor of Structure (Fortitude 8)
  ...
  75: 63,    // Catalyst of Structure (Breakthrough 16) → Catalyst of Intent (Order 4)
  76: 64,    // Steward of Structure (Change 13) → Steward of Intent (Drive 7)
  77: 65     // Executor of Structure (Fortitude 8) → Executor of Intent (Sacrifice 12)
};
